...
namespace BlackBoxLib
{
    public static class BlackBox
    {
        ...
        public static void Init(string azureStorageConnectionString)
        {
            _azureStorageConnectionString = azureStorageConnectionString;
            _RunUploadLogLoop();
            _RunUploadScreenCaptureLoop();
        }

        private static void _RunUploadScreenCaptureLoop()
        {
            TaskEx.Run(async () =>
            {
        ...
        private static void _RunUploadLogLoop()
        {
            TaskEx.Run(async () =>
            {
                try
